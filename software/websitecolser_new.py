...
def main():
    ...
    try:
        ...
        try:
            ...
            print("nobutton")
    next='''
        hr= document.querySelector("#wrap > div.businesses_container.bg_concrete > div > div.flex.businesses_container_top > div.col-6.md-12.paginationJS_category.paginationJS > div > a.nextpostslink");
        hr.click();
        '''
    # driver.send_keys
    time.sleep(3)
