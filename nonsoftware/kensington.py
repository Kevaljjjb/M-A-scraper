...
mainfile="output.csv"
last_csv='./config/last_kensington.csv'
last=[]
new_count=0 
last_count=0
...
def fetch_data(driver,urls):
    for i in urls:
        try:
            ...
            try:
                revenue=driver.find_element(By.XPATH, '//span[contains(text(),"Revenue:")]').text.replace("Revenue: ","")
            except:
                revenue='N/A'
            try:
                cashflow=driver.find_element(By.XPATH, '//span[contains(text(),"Cash Flow:")]').text.replace("Cash Flow: ",'')
            except:
                cashflow='N/A'
            ...
            try:
                ...
                ebitda='N/A'
            try:
                description=driver.find_element(By.XPATH,'//div[@class="content"]').text
            except:
                description = 'N/A'
            try:
            ...
            try:
                ...
                industry='N/A'
            try:
                ask=driver.find_element(By.XPATH,'//div[@class="price"]/h2').text
            except:
                ask='N/A'
...
def main():
    ...
    urls=[]
    driver.get("https://kensingtoncompany.com/business-listings/?_sfm_cash_flow=1000000+1000000000")
    while True:
        # Find and store href and title data
        listings = driver.find_elements(By.XPATH, '//div[@class="business-listing-item"]/a')
